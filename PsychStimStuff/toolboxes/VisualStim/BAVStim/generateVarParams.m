function [orient freq speed contrast phase TempFreq var1value var2value positionX positionY length eye] = generateVarParams(handles)
...
if isfield(handles,'eyeCond0');Eye0 = str2num(get(handles.eyeCond0,'String')); else Eye0 = 1; end % BA backwards compatible (removed eye)
