...
output = importStruct_abf('C:\Documents and Settings\Bassam\My Documents\Scanziani Lab\Patch Data\2006_09_17_0004.abf',-1,1,100,[3:6]);
% toc
%%% USER INPUT Data parameters
nIntracellsignals =2; % #ADC channels which were Intracellular (Code assumes they are contiguous from 1 to N)
...
neighbors = [13 14 15;12 14 15;12 13 15; 12 13 14] % ADC number electrodes that are used with other electrode in spikesorting (waveforms will be concatinated)
