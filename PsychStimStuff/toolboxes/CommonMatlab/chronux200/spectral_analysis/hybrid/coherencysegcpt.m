...
%
% modified by BA
% ADD Major fix: this function should be combined with all other functions
% of similar type (cont, hybrid, point)
% ADD minor : should be possible to call function with any number of argout
...
if nargout < 7  % BA added
    error('Requires 7, 9 or 10 output argruments');
end;

N=check_consistency(data1,data2,1);
