...
% figure(8); plot(spikes.outliers.waveforms'); axis tight;
...
% figure(8); plot(spikes.spiketimes, spikes.overcluster.assigns, '.'); xlabel('Time (sec)'); ylabel('Cluster #');
