...
%
%     The default Chi^2 CDF cutoff is (1 - 1/M), i.e., spikes with Mahalanobis
%     distance such that their Chi^2 are likely to appear less than once by chance
%     are treated as outliers.  To use a different cutoff, specify the value in
%     'SPIKES.OPTIONS.OUTLIER_CUTOFF'; the closer the value (e.g., 1-1e-8) is to
%     1, the fewer spikes will be considered outliers.
%
