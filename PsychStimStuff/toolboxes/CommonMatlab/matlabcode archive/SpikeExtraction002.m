...
fileheader = ['2005_07_13_';'2005_07_14_']
Nfiles_per_header = [5 ; 4]
PROTOCOL = 1; %ICP = 1, ICR = 2
filenumbers = [13 17 9 32 40 6 12 24 36]; %file index for day
CELL_NUM = [07130501 07130501 07130501 07130502 07130503 07140501 07140502 07140503 07140504] %dateCell# 
PUT_TYPE = [1 1 1 2 2 1 1 1 1]% 1= PYR, 2 = Regular spiking 3 = Fast Spiking 0 = Other
