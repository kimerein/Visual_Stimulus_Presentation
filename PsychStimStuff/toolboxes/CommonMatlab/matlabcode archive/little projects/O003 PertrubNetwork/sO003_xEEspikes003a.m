...
readfileheader = ['2006_01_23_'];
savefileheader = ['2006_01_23_'];
readfilenumber  = [6];
% [filename] = createaxonfilename(readfileheader,readfilenumber(1));
bATF =0
[filename] = createaxonfilename(readfileheader,readfilenumber(1),bATF); %ATF
...
if b_loadnewdata
    ...
    if bATF
                my_data(:,:,my_data_zind) = dlmread(pathfilename,'\t',12,0);
    else
