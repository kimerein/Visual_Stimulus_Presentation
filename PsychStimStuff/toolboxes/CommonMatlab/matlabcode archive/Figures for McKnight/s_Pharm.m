...
data = bin2(spiketime,1000);  % Histogram raw spiketime data

% plot spike data with lines were pharmacology was applied
plot(data)
hold
clear sweeptime;
sweepnum = [4 15 24]; %Slice1
sweeptime = sweepnum*20;
...
pharmdata(i).DPCPX 
pharmdata(i).NBQX_baseline 
pharmdata(i).NBQX 
pharmdata(i).GABAZINE_baseline 
pharmdata(i).GABAZINE 
