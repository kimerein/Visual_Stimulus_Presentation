...
warning off
expttype = 'KinateOsc';
writedirpath = [DATAANAL_DIR expttype '\Pairs\'];
...
% xcolor = '-c'; v = -62;% mixed
bVC = 1;
output = importStruct_abf('C:\Documents and Settings\Bassam\My Documents\Scanziani Lab\Patch Data\In\2006_09_21_0043_IN1LFP.abf',-1,1);
...
% thres = -0.05; %% MANUALLY DEFINE threshold for oscilation detection
thres = -15; %% MANUALLY DEFINE threshold for oscilation detection
