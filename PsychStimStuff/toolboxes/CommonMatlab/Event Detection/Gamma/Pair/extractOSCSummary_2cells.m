...
output = importStruct_abf('C:\Documents and Settings\Bassam\My Documents\Scanziani Lab\Patch Data\2006_08_30_0014s.abf',-1,1);
...
ttt =     xcorr(intradata(:,2),lfpdata(:,2),10000,'coeff');
figure(30)
clf
...
subplot(2,3,5)
plot(([1:size(ttt,1)]-((size(ttt,1)-1)/2 +1)).*output.dt.*1000,ttt,xcolor,'LineWidth',2)
hold on
axis tight
xlim([-10 10])
